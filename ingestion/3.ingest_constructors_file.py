...
constructor_final1_df = constructor_dropped_df.withColumnRenamed("constructorId","constructor_id")\
...
constructor_final_df = add_ingestion_date(constructor_final1_df)
...
# %fs
# ls /mnt/devcicddemodl9/processed1/constructors
